...
<body>
<br>
<h1 align="center"><b>List product</b></h1>
<br>
<div align="center">
    <table>
        <tr>
            <th>
                Enter the name of product: <form style="display: inline; width: 100px; height: 50px" class="form-inline my-2 my-lg-0" method="post"
                      action="index.php?page=showInfo">
                    <input name="search" class="form-control" type="search"
                           aria-label="Search">
                    <button style="background-color: black" class="btn btn-success" type="submit">Search</button>
                </form>
            </th>
            <th>
...
<table align="center" class="table" style="width: 1000px;border-radius: 15px">
    ...
    <tr>
        ...
        <th style="width: 300px" colspan="1" scope="col">Option</th>
    </tr>
    </thead>
    <tbody>
    <?php foreach ($products as $key => $product): ?>
        <tr>
            ...
            <td style="text-align: center">
                <a style="width: 100px" class="btn btn-info" href="index.php?page=update&id=<?php echo $product->getId(); ?>">Edit</a>
